...
## 3. 방법론
### 3.1 피쳐 엔지니어링
총 다양한 후보 피쳐를 생성하며, importance 기반으로 핵심 34개의 피쳐를 선별합니다.
...
가격 시계열 단기이동평균(`pma3`) 및 직전 가격(`plag1`), 전/평년 가격대비율(`p_vs_py`, `p_vs_jn`)이 가장 중요하게 반영되었으며, 기후 변수 중에서는 지면온도와 여름무(`summer_mu`) 더미 변수의 기여도가 돋보입니다. 
